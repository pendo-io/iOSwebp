...
// must be deallocated by calling PNDWebPFree(). This function is made available
// by the core 'libwebp' library.
WEBP_NODISCARD WEBP_EXTERN void* PNDWebPMalloc(size_t size);

// Releases memory returned by the PNDWebPDecode*() functions (from decode.h).
WEBP_EXTERN void PNDWebPFree(void* ptr);
